...
tipo_input = sys.argv[14]
tipo_pop = sys.argv[16]
...
try:
    if tipo_input == '0':
        input_sequence = sys.argv[10]
    elif tipo_input == '1':
        input_filename = sys.argv[10]
...
path_output, file_output = os.path.split(sys.argv[11])
path_output1, file_output1 = os.path.split(sys.argv[16])
...
outfile = new_path + dir + '/ResultFiles2PG.zip'
...
resultado = new_path + dir + '/ResultFiles2PG.zip'
