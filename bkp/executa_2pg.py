...
outfile = path + "ResultFiles2PG.zip"
...
resultado = path + 'ResultFiles2PG.zip'
...
envia_email('fisbio.galaxy@gmail.com', user_email, '2PG Execution on Galaxy', assunto_email, [], 'smtp.gmail.com')
