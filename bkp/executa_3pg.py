...
_command = path_ae + 'src/protpred-PEO-Gromacs-NSGA2'
...
outfile = path + "ResultFiles3PG.zip"
...
#z = zipfile.ZipFile(outfile, 'a', zipfile.ZIP_DEFLATED)
#z.write('Final_PDB.pdb')
#z.close()

resultado = path + 'ResultFiles3PG.zip'
...
#renomeia = "cp " + pdb_result + " " + path + "PDB_Final.pdb"
#os.system(renomeia)
...
envia_email('fisbio.galaxy@gmail.com', user_email, '3PG Execution on Galaxy', assunto_email, [], 'smtp.gmail.com')
